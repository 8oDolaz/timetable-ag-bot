...
if __name__ == '__main__':
    main_thread = threading.Thread(target=main(), name='testing my threads', daemon=True)
    parser_thread = threading.Thread(target=parse_timetable(), name='parser_thread', daemon=True)
    parser_thread.start()
    main_thread.start()
    parser_thread.join()
    main_thread.join()
